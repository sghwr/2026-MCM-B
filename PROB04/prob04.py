...
LAMBDA_ENV = 50000  # Environmental monetization coefficient ($/impact unit)
...
def plot_transport_mode_comparison(best_ind):
    ...
    rocket_transport_mass = best_ind.total_launches * Cap_rocket
    elevator_transport_mass = best_ind.total_lift
    
    transport_capacities = [best_ind.total_launches * Cap_rocket, best_ind.total_lift]
    transport_costs = [
        rocket_transport_mass * Cost_rocket,  # 火箭运输成本
        elevator_transport_mass * Cost_lift    # 电梯运输成本
    ]
